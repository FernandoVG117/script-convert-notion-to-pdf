...
var getFieldInfo = function (properties, name, contentType) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_k) {
        switch (_k.label) {
            ...
            case 12: return [2 /*return*/, element.formula.number];
            ...
            case 18: throw new Error("Unknown type ".concat(type));
        }
    });
}); };
...
var getDatabase = function (notion, database_id, contentType, debug) {
    if (debug === void 0) { debug = false; }
    return __awaiter(void 0, void 0, void 0, function () {
        var hasMore, ret, next_cursor, request, results, _i, results_1, page, item;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    next_cursor = (_a = request.next_cursor) !== null && _a !== void 0 ? _a : undefined;
